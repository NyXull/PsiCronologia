...
public class EmailTemplates {
	...
	public static String getEmailRecuperacao(String codigoVerificacao) {
		return String.format("""
			<html>
			<body>
			<h2 style='font-weight: bold; font-family: Comfortaa; color: #182052;'>Olá!</h2>
			<p style='font-family: Nunito; font-size: 16px; color: #000000;'>Este é o seu código de recuperação de senha:</p>
			<h3 style='font-family: Comfortaa; font-size: 24px; color: #182052;'>%s</h3>			
			<p style='font-family: Nunito; font-size: 16px; color: #000000;'>Se você não solicitou, ignore este e-mail.</p>
			</body>
			</html>
			""", codigoVerificacao);
	}
